...
#note[Doplnění bezpečnostní a etické reflexe: Jako třetí směr budoucího rozvoje je žádoucí zmínit kryptografické podepisování commitů vytvořených botem (GPG / Sigstore) pro nezpochybnitelnou provenienci kódu a právní odpovědnost v dodavatelském řetězci softwaru (Supply Chain Security).]
